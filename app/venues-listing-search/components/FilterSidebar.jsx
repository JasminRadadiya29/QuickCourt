...
const FilterSidebar = ({ filters, onFiltersChange, isOpen, onClose, isMobile = false }) => {
  ...
  const priceRanges = [
    { id: 'budget', label: 'Under $25/hour', min: 0, max: 25 },
    { id: 'moderate', label: '$25 - $50/hour', min: 25, max: 50 },
    { id: 'premium', label: '$50 - $100/hour', min: 50, max: 100 },
    { id: 'luxury', label: 'Over $100/hour', min: 100, max: 999 }
  ];
